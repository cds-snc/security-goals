  ...
  releases: [
    ...
    },
    {
      ...
      controls: [
        {
          control: "SA-11",
          fileId: "20-1542987838118--SA-11",
          verifications: [
            {
              timestamp: "2018-11-23T15:21:27Z",
              passed: "true",
              description:
                "The application uses an ESLint file to do so static code analysis."
            },
            {
              timestamp: "2018-11-23T15:21:41Z",
              passed: "true",
              description:
                "This application uses GitHub issues for flaw remediation."
            },
            {
              timestamp: "2018-11-23T15:21:29Z",
              passed: "false",
              description:
                "The application performs code review on its pull requests."
            },
            {
              timestamp: "2018-11-23T15:21:43Z",
              passed: "true",
              description:
                "The application uses snyk to detect package vulnerabilities."
            }
        ...
        {
          control: "SA-11 (4)",
          fileId: "20-1542987838118--SA-11 (4)",
          verifications: [
            {
              timestamp: "2018-11-23T15:21:29Z",
              passed: "false",
        ...
        {
          control: "SA-11 (1)",
          fileId: "22-1542987838118--SA-11 (1)",
          verifications: [
            {
              timestamp: "2018-11-23T15:21:27Z",
              passed: "true",
    ...
    },
    {
      ...
      controls: [
        {
          control: "SA-11 (1)",
          fileId: "427c0129-3d59-4ccb-801f-1b3c29441789--SA-11 (1)",
          verifications: [
            {
        ...
        {
          control: "SI-10",
          fileId: "53d9d7e4-4432-4749-ac4a-e684b81d0d02--SI-10",
          verifications: [
            {
    ...
    },
    {
      ...
      controls: [
        {
          control: "CM-8",
          fileId: "9-1542987838118--CM-8",
          verifications: [
            {
              timestamp: "2018-11-23T15:21:19Z",
              passed: "true",
              description:
                "The application uses kubernetes configuration files to manage its state and information inventory in source control with a log of changes by users."
            }
